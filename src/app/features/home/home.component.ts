...
export class HomeComponent {
  ...
  reviews: Review[] = [
    ...
    { authorFirstName: 'Camille', description:'Nous voilà depuis ce matin à l’aube dans la voiture pour regagner notre façade atlantique, les yeux pleins d’étoiles et le cœur empli de souvenirs ! Nous avons passé 2 semaines magnifiques dans votre maison sous un splendide soleil la quasi totalité du (seuls Nous repartons regonflés à bloc avec un plein de vert, de bleu, de cieux étoilés, de bombes dans la piscine et d’accent belge avec vos adorables voisins ! Bref nous sommes conquis et vous remercions une fois encore de nous avoir permis de vivre ces 15 jours en famille !' },
    { authorFirstName: 'Clarisse', description: 'Bonjour, nous voilà partis avec tristesse de quitter ce si joli lieu, nous avons passé de merveilleuses vacances entre amis dans un décor de rêve. Votre maison est magnifique et tout est parfait pour accueillir 10 personnes. Nous garderons de merveilleux souvenirs de ce lieu, merci!' },
    { authorFirstName: 'Frédéric', description: 'Nous avons passé 4 jours très agréables à Preggio. Votre maison est superbe et nous avons particulièrement aimé la vue, le cadre et le calme. Bon été'}
